...
export function MCQChallenge({challenge, showExplanation = false}){
  ...
  const [shouldShowExplanantion, setShouldShowExplanantion] = useState(showExplanation)
  ...
  const handleOptionSelect = (index) => {
    ...
    setShouldShowExplanantion(true)
  }
  ...
  return(
   <div className="challenge-display">
    ...
    <div className="options">
      ...
      {shouldShowExplanantion && selectedOption !== null && (
